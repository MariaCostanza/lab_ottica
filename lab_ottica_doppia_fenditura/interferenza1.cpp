...
TGraph *graph = new TGraph("int1.txt", "%lg %lg");
...
TF1 *f = new TF1("f", myFunction, 0.015, 0.035, 2);
...
graph->SetTitle("Doppia fenditura 1");


graph->GetXaxis()->SetRangeUser(0.015, 0.035);
graph->Fit("f","R");
graph->Draw("AP");
