...
TGraph *graph = new TGraph("int4_1.txt", "%lg %lg");
...
TF1 *f = new TF1("f", myFunction, 0.063, 0.077, 2);
...
graph->SetTitle("Doppia fenditura 4");


graph->GetXaxis()->SetRangeUser(0.063, 0.077);
graph->Fit("f","R");
graph->Draw("AP");
